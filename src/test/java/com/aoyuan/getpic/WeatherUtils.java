...
public class WeatherUtils {
    ...
    public static Map<String , String> getWeather(String city) {
        try {
            ...
            int four = StringUtils.ordinalIndexOf(weatherInfo, "#", 5);
            int five = StringUtils.ordinalIndexOf(weatherInfo, "#", 6);
            String substring = weatherInfo.substring(four, five);

            int i = StringUtils.ordinalIndexOf(substring, "。", 1);
            int j = StringUtils.ordinalIndexOf(substring, "。", 2);
            String substring1 = substring.substring(i + 1, j);

            int temp = StringUtils.ordinalIndexOf(weatherInfo, "气温", 1);
            int i1 = StringUtils.ordinalIndexOf(weatherInfo, "℃", 1);
            String substring2 = weatherInfo.substring(temp , i1+1);
    ...
    public static void main(String[] args) throws Exception {
        Map<String, String> weather = getWeather("番禺");
